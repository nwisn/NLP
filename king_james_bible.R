...
# define corpus path
cname <- file.path("/home", "ubuntu", "volume", "NLP", "King James Bible 5000")
...
pdf("king_james_bible_wordcloud_dtms_tfidf.pdf", height = 6, width = 6)
set.seed(120)
...
require(ggrepel)
pdf("king_james_bible_biplot.pdf", height = 10, width = 10)
ggbiplot(pca,
         groups = factor(authors),
         ellipse = T,
         alpha = .5,
         main = "King James Bible"
         #labels = titles,
         #labels.size = 2
...
pdf("king_james_bible_heatmap.pdf", height = 12, width = 5, onefile = F)
